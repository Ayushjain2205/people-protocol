...
const Landing = () => {
  return (
    <div className="relative h-screen">
      ...
      >
        <p className="text-white mt-[80px] ml-[27px] mr-[94px] text-[24px] leading-[28px]">
          Hello, what would you like to do?
        </p>
        <button className="w-[336px] h-[55px] rounded-[8px] bg-white mt-[120px] mr-[27px] ml-[27px] font-medium">
